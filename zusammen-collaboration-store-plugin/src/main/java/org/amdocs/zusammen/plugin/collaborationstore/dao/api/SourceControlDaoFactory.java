...
public abstract class SourceControlDaoFactory
    extends AbstractComponentFactory<SourceControlDao> {

  public static SourceControlDaoFactory getInstance() {
    return AbstractFactory
        .getInstance(
            SourceControlDaoFactory.class);
  }

  public abstract <T> SourceControlDao createInterface(SessionContext context);
}

...
public class SourceControlUtilTest {
  ...
  public void init() {
    ...
    sourceControlUtil = spy(new SourceControlUtil());
  ...
  public void testHandleMergeResponse() throws Exception {
    ...
    Mockito.doReturn("10000").when(sourceControlUtil).extractElementIdFromFilePath(anyObject());
  ...
  public void testGetRepoData() throws Exception {
    ...
    Mockito.doReturn(itemVersionMock).when(elementUtil).uploadItemVersionData(null);
